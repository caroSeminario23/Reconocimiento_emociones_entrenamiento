...
cap = cv2.VideoCapture(r'C:\Users\carolina\Documents\VS Code\Reconocimiento_emociones_modelo\Videos\Ansiedad\video6.mp4')  # Cambia esto por la ruta de tu video
...
while True:
    ...
    key = cv2.waitKey(int(200 / fps)) # Es más rápido cuando se reduce el tiempo de espera
